<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Account.aspx.cs" Inherits="work_Account" %>
    ...
    <form id="form1" runat="server">
        <div>
            <asp:Panel ID="Panel1" runat="server" Height="173px">
                <nav class="navbar navbar-expand-lg navbar-light shadow p-3 mb-5 bg-white rounded btn bg-danger">
                    ...
                    <div class="collapse navbar-collapse" id="navbarText">
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item active">
                                <a class="nav-link text--black" href="Delete.aspx">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="14" height="14">
                ...
                <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered table-hover" Width="1000px" AutoGenerateColumns="false" EmptyDataText="没有设定资料" HorizontalAlign="Center" runat="server" PageSize="3" AllowPaging="true" OnPageIndexChanging="GridView1_PageIndexChanging">
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <div class="text-left">
                            ...
                            <ItemStyle HorizontalAlign="Center" Wrap="False" Width="200px" Height="50px" />
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemStyle Width="200px" Wrap="False" HorizontalAlign="Center" />
                            <HeaderTemplate>pass</HeaderTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
                <div class="text-center">
                    <a href="Add.aspx" class="btn btn-info">添加</a>
                    &nbsp&nbsp&nbsp
                    <a href="Modify.aspx" class="btn btn-primary">修改</a>
                    &nbsp&nbsp&nbsp
                    <a href="Delete.aspx" class="btn btn-danger">删除</a>
                </div>
            </asp:Panel>
        </div>
    </form>
