<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Add.aspx.cs" Inherits="work_Add" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <div class="jumbotron">
                ...
                <p class="lead">This is add user mode. Please enter the account and password you want to add.</p>
                <hr class="my-4" />
                ...
                <div class="form-group row">
                    <div class="col-sm-10">
                        <asp:Button ID="Button2" runat="server" Text="添加" OnClick="Button2_Click" class="btn btn-danger" />
                    </div>
                </div>
            </div>
        </div>
