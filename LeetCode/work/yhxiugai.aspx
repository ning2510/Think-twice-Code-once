<%@ Page Language="C#" AutoEventWireup="true" CodeFile="yhxiugai.aspx.cs" Inherits="work_yhxiugai" %>
    ...
    <form id="form1" runat="server">
        <div>
                    ...
                    <div class="collapse navbar-collapse" id="navbarText">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu">
                                <asp:Button ID="Button3" runat="server" Text="   Myself" BackColor="White" BorderStyle="None" OnClick="Button3_Click" />
                                <div class="dropdown-divider"></div>
                                <asp:Button ID="Button2" runat="server" Text="   Others" BackColor="White" BorderStyle="None" OnClick="Button2_Click"/>
                                <div class="dropdown-divider"></div>
            ...
            <div class="jumbotron">
                ...
                <p class="lead">This is modify user's message mode. Please input the message you want to modify.</p>
                <hr class="my-4" />
                ...
                <div class="form-group row">
                    <div class="col-sm-10">
                        <asp:Button ID="Button1" runat="server" Text="修改" OnClick="Button1_Click" class="btn btn-danger" />
                    </div>
                </div>
            </div>
        </div>
