<%@ Page Language="C#" AutoEventWireup="true" CodeFile="用户管理.aspx.cs" Inherits="work_用户管理" %>
                    ...
                    <div class="collapse navbar-collapse" id="navbarText">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="#">Myself</a>
                                <div class="dropdown-divider"></div>
                                <asp:Button ID="Button1" runat="server" Text="    Others" BackColor="White" BorderStyle="None" OnClick="Button1_Click"/>
                                <div class="dropdown-divider"></div>
