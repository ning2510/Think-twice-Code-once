<%@ Page Language="C#" AutoEventWireup="true" CodeFile="write.aspx.cs" Inherits="work_write" %>
    ...
    <form id="form1" runat="server">
        <div>
            <asp:Panel ID="Panel1" runat="server" Height="173px">
                    ...
                    <ItemTemplate>
                        <div class="container">
                            ...
                            <div style="color: #ff0000">
                                <div class="footer">
                                    用户：<%#Eval("username") %>
                                    <span><%#Eval("zfuser") %></span>
                                </div>
                            </div>
                            <div class="card shadow-sm p-3 mb-5 bg-white rounded">
                                <div class="card-body">
                                    <div class="text-left">
                                        <span style="color: #ff0000">点赞量： <%# Eval("redu")%></span>
                                    </div>
                                    <div class="text-center">
                                        <span style="color: #592e8e; font-size: large"><%# Eval("neirong")%></span>
                                    </div>
                                    <div class="text-right">
                                        <asp:Button ID="Button3" runat="server" Text="点赞" CommandName="add" CommandArgument='<%# Eval("cnt")%>' type="button" class="btn btn-outline-info btn-sm" />
                                        <asp:Button ID="Button6" runat="server" Text="转发" CommandName="zhuanfa" CommandArgument='<%# Eval("cnt")%>' type="button" class="btn btn-outline-warning btn-sm" />
                                        <asp:Button ID="Button4" runat="server" Text="修改" CommandName="xiugai" CommandArgument='<%# Eval("cnt")%>' type="button" class="btn btn-outline-primary btn-sm" />
                                        <asp:Button ID="Button5" runat="server" Text="删除" CommandName="delete" CommandArgument='<%# Eval("cnt")%>' type="button" class="btn btn-outline-danger btn-sm" />
                                    </div>
                                    <hr class="my-4">
                                </div>
                                <h5>评论：</h5>
                                <div class="card shadow-sm p-3 mb-5 bg-white rounded">
                                    <asp:Repeater ID="Repeater2" runat="server">
                                        <ItemTemplate>
                                            <div>
                                                <span style="color: #6a6767"><%#Eval("pluser") %>:</span>
                                                <span style="color: #000000"><%# Eval("plnr")%></span>
                                                <hr class="my-4">
                                            </div>
                                        </ItemTemplate>
                                    </asp:Repeater>
                                ...
                                <div class="form-group row">
                                    ...
                                    <asp:Button ID="Button2" runat="server" Text="评论" CommandName="pinglun" CommandArgument='<%# Eval("cnt")%>' type="button" class="btn btn-secondary" />
                                </div>
                            </div>
                        </div>
                    </ItemTemplate>
                ...
                <div class="text-center">
                    <p></p>
                    <asp:Button ID="Button1" runat="server" Text="上传" OnClick="Button1_Click" class="btn btn-primary" />
                    <asp:FileUpload ID="FileUpload1" runat="server" />
                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                    <asp:TextBox ID="TextBox1" runat="server" Width="300" BackColor="White"></asp:TextBox>
                    <asp:Button ID="Button2" runat="server" Text="留言" OnClick="Button2_Click" class="btn btn-danger" />
                </div>
