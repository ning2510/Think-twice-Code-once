<%@ Page Language="C#" AutoEventWireup="true" CodeFile="管理登录.aspx.cs" Inherits="work_管理登录" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <div class="jumbotron">
                ...
                <p class="lead">This is the administrator login mode. Please enter your account and password first.</p>
                <hr class="my-4" />
                ...
                <div class="form-group row">
                    <div class="col-sm-10">
                        ...
                        <asp:Button ID="Button2" runat="server" Text="取消" OnClick="Button2_Click" class="btn btn-danger " />
                    </div>
                </div>
            </div>
        </div>
